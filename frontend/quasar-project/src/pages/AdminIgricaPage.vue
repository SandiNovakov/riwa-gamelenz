  ...
  <q-page padding class="flex justify-center items-start">
    <div class="all column q-pa-md justify-center">
      ...
      <div class="column q-gutter-md">
        <q-input filled v-model="imeIgrice" label="Naziv igre" />
...
import { getImage, saveImage, deleteImage } from "src/utils/images";
...
const opis = ref("");
const slika = ref("");
const previewUrl = ref(null); //prikazuje se postojeca slika
...
async function updateGame() {
  try {
    ...
    if (slika.value) {
      await saveImage("igrica", gameId, "cover", slika.value);
    }
...
async function deleteGame() {
  ...
  try {
    ...
    await deleteImage("igrica", gameId, "cover");
